    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-4rem)]">
      <div className="w-full max-w-md p-8 space-y-6 border rounded-lg">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">Join the coding battle arena</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            onClick={() => {
              ...
              const callbackUrl = process.env.NEXT_PUBLIC_GOOGLE_CALLBACK_URL || 'http://localhost:3000/auth/callback/google';
              window.location.href = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${clientId}&redirect_uri=${encodeURIComponent(callbackUrl)}&response_type=code&scope=email%20profile`;
            }}
            className="flex items-center justify-center py-2 px-4 border rounded-md hover:bg-accent transition-colors font-medium text-sm"
          >
          ...
          <button
            onClick={() => {
              ...
              const callbackUrl = process.env.NEXT_PUBLIC_GITHUB_CALLBACK_URL || 'http://localhost:3000/auth/callback/github';
